...
function configureOutboundSlaveToSlaveConnection(c) {
  c.send("Hello Fellow Slave, I found you in the phone book")
        ...
        for(i = 0; i < myFrontPeers.length; i++)
        {
          ...
          if( typeof connectedPeers[peerName] == 'undefined' )
          {
            ...
            newPeerCon.on('open', function() {
              configureOutboundSlaveToSlaveConnection(newPeerCon)
            });
          }
        }
